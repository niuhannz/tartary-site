...
/* ═══════════════════════════════════════════════════
   AnimatedGridPattern — SVG grid with randomly
   appearing/fading squares

   Ported from Magic UI. Creates a subtle background
   pattern where grid cells pulse in and out, giving
   a living, digital feel.
   ═══════════════════════════════════════════════════ */
    ...
    const resizeObserver = new ResizeObserver((entries) => {
      for (const entry of entries) {
        setDimensions((current) => {
          ...
          if (current.width === nextW && current.height === nextH) return current;
